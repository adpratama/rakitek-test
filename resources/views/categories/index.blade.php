               ...
               <table class="border-collapse table-auto w-full text-sm">
                  <thead>
                     <tr>
                        ...
                        <th class="border-b font-medium p-4 pl-8 pt-0 pb-3 ">Aksi</th>
                     </tr>
                  </thead>
                  <tbody >
                     @foreach($items as $item)
                        <tr>
                           ...
                           <td class="border-b border-slate-100 p-4 pl-8">
                              <a href="{{ route('categories.edit', $item->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                 Edit
                              </a>
                              <span>&nbsp;</span>
